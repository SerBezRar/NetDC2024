...
### Цель проекта
Цель проекта выбрана в качестве вероятного сценария при ответе на внутренний запрос бизнеса компании на разработку дизайна сети под предполагаемую новую локацию ЦОД.
