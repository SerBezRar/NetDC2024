...
Аспекты:
- не получилось запустить для Overlay фичу Arista для лёгкого масштабирования BGP - bgp listen, чтобы с минимальной конфигурацией на Spine принимать подключения от Leaf. Для Underlay - заработала без проблем.
