...
Цель проекта - "Создание новой сети на базе технологий EVPN VXLAN", выбрана в соответствии с вероятным сценарием при ответе на внутренний запрос бизнеса компании на разработку дизайна сети под предполагаемую новую локацию ЦОД.
