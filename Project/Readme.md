...
- конфигурирование тестового стенда
- проверка нужных технологий
...
значительное масштабирование без изменения ключевых компонентов
...
Также используется BFD для ускорения сходимости
Также используется LACP для подключения конечных хостов
Не используется Auth для упрощения тестового стенда
...
- маршрутизацию внутри фабрики на основе Symmetric IRB и работу L3VNI
